...
module.exports = {
  ...
  packname: process.env.packname || "Alvin",
  author: process.env.author || "𝙻𝚘𝚛𝚍 Al𝚟𝚒𝚗",
  //==========================================- API-CONFIGS -==========================================================
...
//------------------------------------------------------------------------------------------------------------------
  ...
  START_MSG: process.env.START_MSG || `🚀 *_ALVIN-MD Connected Successfully!_* ✅ 
...
> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍᴀʟᴠɪɴ ᴋɪɴɢ ᴛᴇᴄʜ*` ,
  ...
  ALIVE_IMG: process.env.ALIVE_IMG || "https://c.top4top.io/p_32402xbvw0.jpg",
  MENU_IMG: process.env.MENU_IMG || "https://c.top4top.io/p_32402xbvw0.jpg",
